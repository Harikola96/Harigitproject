...
public final class WebSiteUtility 
{
    ...
    public static FluentWait<WebDriver> defineExplicitWait(WebDriver driver,
    		                                               int timeoutsec,
    		                                               int intervalmillis)
    {
    ...
    public static String capturePageScreenshotAsFile(WebDriver driver) throws Exception
	{
   ...
   /* public static String captureFullPageScreenshotAsFile(WebDriver driver) throws Exception
    {
          SimpleDateFormat sf=new SimpleDateFormat("dd-MMM-yyyy-hh-mm-ss-SSS");
          Date dt=new Date();
