...
public final class CookiesUtility 
{
	...
	public static int getCookiesCount(WebDriver driver)
	{
		int x=driver.manage().getCookies().size();
		return(x);
	}
	public static List<Cookie> getCookiesList(WebDriver driver)
	{
		Set<Cookie> cs=driver.manage().getCookies();
		List<Cookie> cl=new ArrayList<Cookie>(cs);
		return(cl);
	}
	public static List<String> getCookiesDetailsList(WebDriver driver)
	{
		Set<Cookie> cs=driver.manage().getCookies();
		List<Cookie> cl=new ArrayList<Cookie>(cs);
	...
	//use null for "superdomain" argument when no super domain does not exist for our SUT
	public static List<String> getCookiesTypes(
	...
	public static void addNewCookie(WebDriver driver, String name, String value, String domain, 
	...
	public static void addNewCookieViaBuilder(WebDriver driver, String name, String value, 
	...
	public static void deleteCookieByIndex(WebDriver driver, int index)
	{
